...
avg_words=$((word_count / line_count)) # logic error: division by zero instead of line_count #Replaced 0 with line_count to cure. -A.D.
...
while [ $counter -gt 0 ]; do
    ...
    counter=$((counter - 1)) # logic error: increment instead of decrement # Switched increment to decrement to cure. -A.D.
